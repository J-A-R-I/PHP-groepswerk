    ...
    <div class="flex items-center justify-center min-h-[70vh]">
        <div class="w-full max-w-md bg-white rounded-xl shadow-lg p-8 border border-gray-100">
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-gray-900">Welkom terug</h1>
                <p class="text-gray-500 mt-2">Log in om materiaal te reserveren.</p>
            </div>
...
// FIX: Gebruik ../layouts i.p.v. ../../layouts
